...
public class Jump {
	...
	public Jump(final int x1, final int y1, final int captureX,
			final int captureY, final int x2, final int y2) {
		this.x1 = x1;
		this.y1 = y1;
	...
	public String toString() {
		return "Jump [x1=" + x1 + ", y1=" + y1 + ", captureY=" + captureY
				+ ", captureX=" + captureX + ", x2=" + x2 + ", y2=" + y2 + "]";
	}
